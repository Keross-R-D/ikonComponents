...
import { AgentDropdown, Agent } from "./agent-dropdown";
...
export const Thread: FC<{
  ...
  const [selectedAgent, setSelectedAgent] = useState<Agent | undefined>(
    agents.find((a) => a.agentID === initialAgentId),
  );
  return (
        ...
        >
          ...
          >
            <ThreadPrimitive.If empty>
              <ThreadWelcome currentUserDetails={currentUserDetails} />
            </ThreadPrimitive.If>
...
const ThreadWelcome: FC<{ currentUserDetails: UserData }> = ({
  currentUserDetails,
}) => {
  const now = new Date();
    ...
    <div className="aui-thread-welcome-root mx-auto my-auto flex w-full max-w-[var(--thread-max-width)] flex-grow flex-col">
      <div className="aui-thread-welcome-center flex w-full flex-grow flex-col items-center justify-center">
        <div className="aui-thread-welcome-message flex size-full flex-col justify-center px-8">
          ...
          >
            {`${greeting} ${currentUserDetails.userName.split(" ")[0]}`}
          </m.div>
          <m.div
            initial={{ opacity: 0, y: 10 }}
            animate={{ opacity: 1, y: 0 }}
